...
class _$ArticleImpl implements _Article {
  const _$ArticleImpl(
      {@HiveField(0) required this.source,
      @HiveField(1) required this.title,
      @HiveField(2) required this.description,
      @HiveField(3) required this.url,
      @HiveField(4) required this.urlToImage,
  ...
  @override
  String toString() {
    return 'Article(source: $source, title: $title, description: $description, url: $url, urlToImage: $urlToImage, publishedAt: $publishedAt, content: $content)';
  }
...
abstract class _Article implements Article {
  const factory _Article(
      {@HiveField(0) required final Source source,
      @HiveField(1) required final String title,
      @HiveField(2) required final String? description,
      @HiveField(3) required final String url,
      @HiveField(4) required final String? urlToImage,
      @HiveField(5) required final DateTime publishedAt,
      @HiveField(6) required final String? content}) = _$ArticleImpl;
...
class _$SourceImpl implements _Source {
  const _$SourceImpl({@HiveField(0) this.id, @HiveField(1) this.name});
...
abstract class _Source implements Source {
  const factory _Source(
      ...
      @HiveField(1) final String? name}) = _$SourceImpl;
